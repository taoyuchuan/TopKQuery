...
int main()
{
  ...
  cout << "Performnce Evaluation on Correlated Dataset (n = 500000, m = 8, k = 20, p = 10):" << endl;
  ...
  cout << "n: number of data items      m: number of lists      k: top k value      p: percent of fluctuation " << endl << endl << endl;
