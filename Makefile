all: dataset.x bruteforce.x FA.x BPA.x BPA2.x compare.x
...
compare.x: DataItem.cpp DataSet.cpp DataOverallScore.cpp TopKAlgorithm.cpp BruteForce.cpp FA.cpp BPA.cpp BPA2.cpp compare.cpp Makefile
	g++ -std=c++11 -O3 -o compare.x DataItem.cpp DataSet.cpp DataOverallScore.cpp TopKAlgorithm.cpp BruteForce.cpp FA.cpp BPA.cpp BPA2.cpp compare.cpp
